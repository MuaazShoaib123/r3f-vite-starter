...
export function Avatar(props) {
  ...
  const {actions} = useAnimations([StandingIdle[0],StandingPose[0],Pointing[0],StandingArguing[0],Talking[0],Talkingf[0],WalkCircle[0],Walkleft[0],Walking[0],Yelling[0],Talking3[0]],group);
